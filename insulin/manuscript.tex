...
the formate-generation potential tabulated by Pietzke et al.~\cite{pietzke2020} --- the formaldehyde released by demethylation of caffeine and
...
\begin{figure}[t]
  ...
  \cite{pietzke2020} (coloured by category, formate per serving annotated) plus
...
\begin{figure}[t]
  ...
  ordered by formate content (mg per serving in parentheses); the
...
The key calibrated and predicted quantities of this run are collected in
Table~\ref{tab:key}.
